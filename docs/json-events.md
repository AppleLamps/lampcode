...
| `tool.executing` | Tool dispatch started (after hooks/approval) | `tool_name`, `arguments`, `source` |
| `tool.completed` | Tool finished | `tool_name`, `status`, `source`, `summary`, `output` (truncated) |
...
{"type":"tool.executing","ts":"...","thread_id":"abc","turn_id":"turn-1","payload":{"tool_name":"read_file","arguments":{"path":"calc.py"}}}
